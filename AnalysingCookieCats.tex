...
\hypersetup{
  pdftitle={Analysing Cookie Cats},
  pdfauthor={Pau, Mikel, Pablo},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Analysing Cookie Cats}
...
\hypertarget{getting-to-know-the-datasets}{%
\subsection{1. Getting to know the
datasets}\label{getting-to-know-the-datasets}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{DS}\OtherTok{=}\FunctionTok{read.csv}\NormalTok{(}\StringTok{"cookie\_cats\_ABtest.csv"}\NormalTok{)}
\NormalTok{PR}\OtherTok{=}\FunctionTok{read.csv}\NormalTok{(}\StringTok{"cookie\_cats\_purch.csv"}\NormalTok{)}
